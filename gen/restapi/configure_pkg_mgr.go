...
//go:generate swagger generate server --target ../../gen --name PkgMgr --spec ../../api/openapi-spec/swagger.yaml --exclude-main

func configureFlags(api *operations.PkgMgrAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.PkgMgrAPI) http.Handler {
